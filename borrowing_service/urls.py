...
from borrowing_service.views import BorrowingViewSet, PaymentViewSet, create_checkout_session
...
urlpatterns = [
    ...
    path('payments/<int:pk>/success/', PaymentViewSet.as_view({'get': 'payment_success'}), name='payment-success'),
    path('payments/<int:pk>/cancel/', PaymentViewSet.as_view({'get': 'cancel_payment'}), name='cancel-payment'),
